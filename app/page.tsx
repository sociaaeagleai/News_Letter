        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="text-center max-w-6xl mx-auto mb-20 relative">
            <div className="relative z-10">
              ...
              >
                <h1 className="text-6xl md:text-8xl mb-8 bg-gradient-to-r from-[#f538e8] via-[#884bfa] to-[#4c94f8] bg-clip-text text-transparent leading-[1.1] pb-1 font-[Archivo] font-extrabold">
